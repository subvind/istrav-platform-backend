...
export class CaslAbilityFactory {
  createForUser(account: Account) {
    ...
    cannot(Action.UPDATE, SocialGroup);
    cannot(Action.REMOVE, SocialGroup);
    can(Action.UPDATE, SocialGroup, { id: account.member.id });
    can(Action.REMOVE, SocialGroup, { id: account.member.id });
